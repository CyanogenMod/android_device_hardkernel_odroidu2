...
/******************************************************************************
 *
 *  Filename:      bt_vendor_genericserial
 *
 *  Description:   generic serial bluetooth support (ftdi cable -> WML-C20AH)
 *
 ******************************************************************************/
...
#include <fcntl.h>
#include <termios.h>
#include "bt_vendor_genericserial.h"
